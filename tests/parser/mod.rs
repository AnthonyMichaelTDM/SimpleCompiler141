...
#[case::error_string("errorString.c", Err("Parse error: Scanner encountered an error: Illegal character '%' found at position 1".to_string()))]
...
#[case::parse2("parse2.c", Err("Parse error: Scanner encountered an error: Illegal character '@' found at position 120".to_string()))]
